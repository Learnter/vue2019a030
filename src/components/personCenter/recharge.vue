      ...
      <div class="recharge_main">
          ...
          <div class="convert_box">
              ...
              <div class="convert_box_list">
                  <ul>
                      <li v-for="(item,index) in 6" :key="index" :class="index == con_actived ? 'convert_actived':''" @click="convertTab(index)">
                          <span class="integral">赠送1000积分</span>
                          <p class="convert_youBi">360邮币</p>
                          <p class="convert_monery">&yen;300.00</p>
                      </li>
                  </ul>
              </div>
          </div>
...
export default {
    ...
    methods:{
        ...
        convertTab(index){ //兑换方案切换
            this.con_actived =  index;
        },
        paymentTab(index){ //支付方式切换
